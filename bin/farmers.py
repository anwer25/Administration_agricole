...
class Ui_farmers(object):
    def setupUi(self, farmers):
        ...
        farmers.setWindowModality(QtCore.Qt.WindowModal)
        farmers.resize(1366, 705)
        farmers.setMinimumSize(QtCore.QSize(0, 0))
        farmers.setBaseSize(QtCore.QSize(1366, 705))
        font = QtGui.QFont()
        ...
        self.data.horizontalHeader().setDefaultSectionSize(218)
    ...
    def retranslateUi(self, farmers):
        ...
        farmers.setWindowTitle(_translate("farmers", "D.P.A-فلاحة"))
