...
class Ui_newFarmers(object):
    def setupUi(self, newFarmers):
        ...
        self.openCamera = QtWidgets.QPushButton(newFarmers)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.openCamera.setFont(font)
        self.openCamera.setObjectName("openCamera")
        self.gridLayout.addWidget(self.openCamera, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_8, 3, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.save, 8, 0, 1, 3)
        self.cancel = QtWidgets.QPushButton(newFarmers)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.cancel.setFont(font)
        self.cancel.setObjectName("cancel")
        self.gridLayout.addWidget(self.cancel, 8, 3, 1, 1)
    ...
    def retranslateUi(self, newFarmers):
        ...
        self.openCamera.setText(_translate("newFarmers", "باستخدام الكاميرا"))
