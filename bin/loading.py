...
"}")
        ...
        self.title_label.setGeometry(QtCore.QRect(6, 30, 611, 71))
        font = QtGui.QFont()
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 140, 601, 23))
...
"}")
        ...
        self.loading_label.setGeometry(QtCore.QRect(0, 180, 621, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.Credite.setGeometry(QtCore.QRect(10, 240, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.version.setGeometry(QtCore.QRect(520, 240, 91, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title_label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">D.P.A</p></body></html>"))
        self.loading_label.setText(_translate("MainWindow", "<html><head/><body><pre style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-family:\'Courier New\';\">...</span><a name=\"tw-target-text-container\"/><span style=\" font-family:\'Courier New\';\">ت</span><span style=\" font-family:\'Courier New\';\">حميل الموارد</span></pre></body></html>"))
        self.Credite.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Crédité</span>:AlphaSoft </p></body></html>"))
