...
# Form implementation generated from reading ui file 'E:\python-project\Administration_agricole\UI\searchMethod.ui'
#
...
class Ui_searchMethod(object):
    def setupUi(self, searchMethod):
        ...
        self.dateFrom.setLayoutDirection(QtCore.Qt.RightToLeft)
    ...
    def retranslateUi(self, searchMethod):
        ...
        self.dateTO.setDisplayFormat(_translate("searchMethod", "yyyy/MM/dd"))
        self.label.setText(_translate("searchMethod", ":   من"))
        self.dateSearchOnOff.setText(_translate("searchMethod", "البحث باستخدام التاريخ"))
        self.dateFrom.setDisplayFormat(_translate("searchMethod", "yyyy/MM/dd"))
