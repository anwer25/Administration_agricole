...
class Ui_distribution(object):
    def setupUi(self, distribution):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(680, 10, 681, 681))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        ...
        self.displayByDeanships.setGeometry(QtCore.QRect(508, 42, 49, 28))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        ...
        self.displayByCIN.setGeometry(QtCore.QRect(339, 42, 61, 28))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.searsh.setGeometry(QtCore.QRect(85, 77, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.label.setGeometry(QtCore.QRect(592, 42, 73, 24))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.label_2.setGeometry(QtCore.QRect(339, 76, 75, 24))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.label_3.setGeometry(QtCore.QRect(592, 76, 62, 24))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.deanships.setGeometry(QtCore.QRect(508, 77, 76, 30))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.searshButton.setGeometry(QtCore.QRect(1, 76, 75, 32))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.farmersListTable.setGeometry(QtCore.QRect(1, 124, 671, 551))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(16)
        ...
        self.farmersListTable.setDragEnabled(False)
        self.farmersListTable.setDragDropOverwriteMode(False)
        self.farmersListTable.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        ...
        self.groupBox.setGeometry(QtCore.QRect(9, 9, 621, 691))
        font = QtGui.QFont()
        font.setFamily("Arabic Typesetting")
        font.setPointSize(19)
        ...
        self.gridLayout.addWidget(self.print, 1, 1, 1, 1)
        ...
        self.printingList.setProperty("showDropIndicator", False)
        self.printingList.setDragEnabled(False)
        self.printingList.setDragDropOverwriteMode(False)
        self.printingList.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        ...
        self.printingList.horizontalHeader().setDefaultSectionSize(80)
        ...
        self.gridLayout.addWidget(self.printingList, 4, 1, 1, 3)
        self.moveToPrint = QtWidgets.QPushButton(distribution)
        self.moveToPrint.setGeometry(QtCore.QRect(640, 310, 31, 36))
        font = QtGui.QFont()
        font.setPointSize(29)
        font.setBold(True)
        font.setWeight(75)
        self.moveToPrint.setFont(font)
        self.moveToPrint.setObjectName("moveToPrint")
        self.removeFromPrint = QtWidgets.QPushButton(distribution)
        self.removeFromPrint.setGeometry(QtCore.QRect(640, 370, 31, 36))
        font = QtGui.QFont()
        font.setPointSize(29)
        font.setBold(True)
        font.setWeight(75)
        self.removeFromPrint.setFont(font)
        self.removeFromPrint.setObjectName("removeFromPrint")
    ...
    def retranslateUi(self, distribution):
        ...
        self.moveToPrint.setText(_translate("distribution", "<<"))
        self.removeFromPrint.setText(_translate("distribution", ">>"))
