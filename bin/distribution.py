...
class Ui_distribution(object):
    def setupUi(self, distribution):
        ...
        self.farmersListTable.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.farmersListTable.setDragDropMode(QtWidgets.QAbstractItemView.DragDrop)
        ...
        self.farmersListTable.setColumnCount(3)
        ...
        self.farmersListTable.horizontalHeader().setDefaultSectionSize(219)
        ...
        self.printingList.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        self.printingList.setColumnCount(4)
        ...
        self.printingList.horizontalHeader().setDefaultSectionSize(162)
